...
class TextGenerator:
    def __init__(self, 
                 ...
                 tokenizer_model_path='/home/zhanghudong/llm/test/happy-llm-215M-base/tokenizer_k',  # 分词器模型路径
                 seed=42,  # 随机种子，确保可重复性
...
if __name__ == "__main__":
    ...
    generator = TextGenerator(checkpoint='/home/zhanghudong/llm/test/happy-llm-215M-base/pretrain_1024_18_6144.pth')  # 初始化生成器
